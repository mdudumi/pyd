...
const translations = {
  ...
  sq: {
    ...
    allPrio: 'Të gjitha Prioritetet',
    catGeneral: 'Gjenerale',
    catReading: 'Lexim',
    catPrayer: 'Lutje',
    catFellowship: 'Vëllazëri',
    catOutreach: 'Arritje',
    catFamily: 'Familje',
    prioLow: 'Prioritet i ulët',
    prioMed: 'Prioritet mesatar',
    prioHigh: 'Prioritet i lartë',
    repeatNone: 'Pa përsëritje',
    repeatDaily: 'Përditë',
    repeatWeekly: 'Javor',
    dueTitle: '🔔 Detyra është afër',
    snooze: 'Merr më vonë',
    dismiss: 'Anuloj',
    footer: '© 2025 Plan Your Day. Të gjitha të drejtat e rezervuara.'
  },
  it: {
    title: 'Pyd Planner',
    ...
    catOutreach: 'Outreach',
    catFamily: 'Famiglia',
    prioLow: 'Bassa Priorità',
    prioMed: 'Priorità Media',
    prioHigh: 'Alta Priorità',
    repeatNone: 'Nessuna Ripetizione',
    repeatDaily: 'Quotidiana',
    repeatWeekly: 'Settimanale',
    dueTitle: '🔔 Attività in scadenza',
    snooze: 'Posponi',
    dismiss: 'Ignora',
  ...
  fr: {
    ...
    allPrio: 'Toutes les Priorités',
    catGeneral: 'Général',
    catReading: 'Lecture',
    catPrayer: 'Prière',
    catFellowship: 'Communauté',
    catOutreach: 'Sensibilisation',
    catFamily: 'Famille',
    prioLow: 'Priorité Basse',
    prioMed: 'Priorité Moyenne',
    ...
    snooze: 'Rappeler',
    dismiss: 'Ignorer',
    footer: '© 2025 Plan Your Day. Tous droits réservés.'
  },
  de: {
    title: 'Pyd Planner',
    ...
    catOutreach: 'Outreach',
    catFamily: 'Familie',
    prioLow: 'Niedrige Priorität',
    prioMed: 'Mittlere Priorität',
    prioHigh: 'Hohe Priorität',
    repeatNone: 'Keine Wiederholung',
    repeatDaily: 'Täglich',
    repeatWeekly: 'Wöchentlich',
    dueTitle: '🔔 Aufgabe fällig',
    snooze: 'Verschieben',
    dismiss: 'Verwerfen',
        ...
        <div class="space-y-2">
          <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-3 text-2xl">
              ...
              <button data-act="share-whatsapp" class="text-green-500">📤</button>
              <button data-act="share-email" class="text-blue-500">✉️</button>
            </div>
          </div>
